...
{
    public class UploadFileSingleService : IUploadFileSingleService
    {
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly IConfiguration _configuration;

        public UploadFileSingleService(IWebHostEnvironment webHostEnvironment, IConfiguration configuration)
        {
